...
export const skills = [
	...
	{
		name: "C / C++",
		level: { en: "Proficient", fr: "Compétent" },
		category: "lang",
	},
	{
		name: "Java & C#",
	...
	},
	{
		...
		frName: "Programmation Système",
		level: { en: "Advanced", fr: "Avancé" },
		category: "systems",
	},
	{
		name: "Compiler Design",
		frName: "Conception de Compilateurs",
		level: { en: "Intermediate", fr: "Intermédiaire" },
		category: "systems",
	},
	{
		name: "Concurrency / Multithreading",
		frName: "Concurrence / Multithreading",
		level: { en: "Advanced", fr: "Avancé" },
		category: "systems",
	},
];
	...
	},
	{
		...
		locales: {
			en: {
				...
				description:
					"A Bytecode interpreter written in Rust. Direct register allocation, memory mapping with no external libs.",
				status: "Systems",
			},
			fr: {
